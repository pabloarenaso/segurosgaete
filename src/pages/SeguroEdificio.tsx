...
import { ArrowRight, ArrowLeft, Building2, Flame, Droplets, Scale, ShieldCheck, Cog, PanelTop, Check, Mail, Phone, Shield, ChevronDown, HelpCircle } from 'lucide-react';
...
const coverageOptions = [{
  ...
  icon: Shield,
  details: {
    coberturas: ['Incendio y rayo', 'Terremoto (cobertura básica)', 'Responsabilidad civil limitada (hasta 500 UF)'],
  ...
  recommended: true,
  details: {
    coberturas: ['Todo lo del plan Básica', 'Daños por agua y filtraciones', 'Robo de especies comunes', 'Equipos y maquinarias (ascensores, calderas)', 'Vidrios y cristales', 'Responsabilidad civil ampliada (hasta 2.000 UF)'],
  ...
  icon: Shield,
  details: {
    coberturas: ['Todo lo del plan Intermedia', 'Cobertura todo riesgo', 'Lucro cesante por siniestro', 'Gastos de remoción de escombros', 'Pérdida de arriendos', 'Responsabilidad civil ilimitada'],
...
const benefits = [{
  ...
  description: "Cobertura ante siniestros mayores incluyendo daños estructurales y contenido común del edificio"
}, {
  icon: Droplets,
  title: "Daños por Agua",
  description: "Incluye filtraciones en techos, roturas de matrices y daños a terceros por humedad"
}, {
  icon: Scale,
  title: "Responsabilidad Civil",
  description: "Protección legal si un tercero sufre un accidente en las áreas comunes del edificio"
}, {
  icon: ShieldCheck,
  title: "Robo Especies Comunes",
  description: "Cubre hurto de equipamiento, mobiliario y bienes ubicados en espacios compartidos"
}, {
  icon: Cog,
  title: "Equipos y Maquinarias",
  description: "Ascensores, calderas, bombas de agua y generadores eléctricos asegurados"
}, {
  icon: PanelTop,
  title: "Vidrios y Cristales",
  description: "Reposición de ventanales, mamparas, espejos y puertas de cristal dañadas"
}];
const faqs = [{
  question: "¿Qué documentos necesito para cotizar?",
  answer: "Solo necesitas información básica del edificio: dirección, cantidad de departamentos y tipo de construcción."
}, {
  question: "¿Cuánto demora el proceso de contratación?",
  answer: "Una vez aprobada la propuesta, el proceso toma entre 24 a 48 horas hábiles."
}, {
  question: "¿Puedo modificar mi cobertura después?",
  answer: "Sí, puedes ajustar tu cobertura en cualquier momento."
}, {
  question: "¿Cómo reporto un siniestro?",
  answer: "Contáctanos inmediatamente por WhatsApp, teléfono o email."
}];
