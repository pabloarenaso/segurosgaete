...
import { ArrowRight, ArrowLeft, Shield, HeartPulse, Briefcase, Clock, FileCheck, Check, Mail, Phone, Building, Users, ChevronDown, Scale, Umbrella, HelpCircle } from 'lucide-react';
...
const coverageOptions = [{
  ...
  icon: Shield,
  details: {
    coberturas: ['Muerte natural o accidental', 'Indemnización según montos DS-93'],
  ...
  recommended: true,
  details: {
    coberturas: ['Todo lo del plan Básico', 'Invalidez total permanente', 'Invalidez parcial permanente', 'Gastos funerarios', 'Cobertura 24/7 (laboral y extralaboral)'],
  ...
  icon: Shield,
  details: {
    coberturas: ['Todo lo del plan Completo', 'Asistencia familiar extendida', 'Repatriación de restos', 'Doble indemnización por accidente', 'Anticipo por enfermedad terminal'],
...
const benefits = [{
  ...
  description: "Indemnización para los beneficiarios según los montos establecidos en la normativa DS-93"
}, {
  icon: Scale,
  title: "Invalidez Total o Parcial",
  description: "Compensación económica por incapacidad laboral permanente causada por accidente o enfermedad"
}, {
  icon: Briefcase,
  title: "Gastos Funerarios",
  description: "Apoyo económico inmediato para la familia en momentos difíciles, sin trámites complicados"
}, {
  icon: Shield,
  title: "Cumplimiento Legal",
  description: "Tu empresa cumple con la obligación legal del Decreto Supremo 93, evitando multas y sanciones"
}, {
  icon: Umbrella,
  title: "Cobertura 24/7",
  description: "Protección continua dentro y fuera del horario laboral, los 365 días del año"
}, {
  icon: FileCheck,
  title: "Gestión Simplificada",
  description: "Nos encargamos de todos los trámites ante la aseguradora, tú solo nos avisas"
}];
const faqs = [{
  question: "¿Qué es el DS-93?",
  answer: "El Decreto Supremo 93 establece la obligatoriedad de un seguro de vida para guardias de seguridad."
}, {
  question: "¿Es obligatorio para todas las empresas?",
  answer: "Sí, toda empresa con personal de seguridad debe cumplir con esta normativa."
}, {
  question: "¿Cuánto cuesta el seguro por guardia?",
  answer: "El costo varía según la cobertura, desde UF 0.5 por guardia al mes."
}, {
  question: "¿Qué pasa si no tengo el seguro?",
  answer: "El incumplimiento puede resultar en multas y responsabilidades legales para la empresa."
}];
const VidaGuardias = () => {
  ...
  return <Layout>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-center md:text-left">
              ...
              <motion.h1 className="text-3xl lg:text-5xl font-bold text-primary-foreground mb-4" initial={{
              opacity: 0,
              y: 20
            }} animate={{
              opacity: 1,
              ...
              <motion.p className="text-xl text-primary-foreground/90 mb-8 max-w-2xl" initial={{
              opacity: 0,
              y: 20
            }} animate={{
              opacity: 1,
              ...
              delay: 0.3
                ...
                <Button size="lg" className="bg-background text-primary hover:bg-background/90" onClick={() => document.getElementById('formulario')?.scrollIntoView({
                behavior: 'smooth'
              })}>
            ...
            <motion.div className="hidden md:flex justify-center items-center" initial={{
            opacity: 0,
            scale: 0.9
          }} animate={{
            opacity: 1,
            ...
            delay: 0.3
              ...
              <img src={logoBlanco} alt="Seguros Gaete" className="h-48 lg:h-64 xl:h-80 w-auto drop-shadow-2xl opacity-90" />
            </motion.div>
          </div>
        </div>
      </section>
              ...
              <AnimatePresence mode="wait">
                ...
                x: -20
                    ...
                    <div className="space-y-3">
                      {coverageOptions.map(option => <label key={option.value} className={`relative flex items-center p-4 rounded-xl border-2 cursor-pointer transition-all ${coverage === option.value ? 'border-primary bg-primary/5 shadow-lg' : 'border-border hover:border-primary/50'}`}>
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              {coverage === option.value && <Dialog>
                                  <DialogTrigger asChild>
                                    <button type="button" onClick={e => e.stopPropagation()} className="flex items-center gap-1 text-xs font-medium text-primary hover:text-primary/80 transition-colors underline underline-offset-2 whitespace-nowrap" aria-label={`Ver detalles del plan ${option.label}`}>
                                    ...
                                    <div className="space-y-4">
                                      <div>
                                        ...
                                        <ul className="space-y-1.5">
                                          {option.details.coberturas.map((cobertura, i) => <li key={i} className="flex items-start gap-2 text-sm">
                                              <Check className="w-4 h-4 text-primary mt-0.5 shrink-0" />
                                              <span>{cobertura}</span>
                                            </li>)}
                                        </ul>
                                      </div>
                                      {'montos' in option.details && option.details.montos && <div>
                          ...
                          {coverage === option.value && <div className="w-6 h-6 rounded-full bg-[#25D366] flex items-center justify-center ml-3 shrink-0">
                ...
                x: -20
                    ...
                    <label htmlFor="terms" className="flex items-center gap-3 mb-6 cursor-pointer group" onClick={() => setValue('termsAccepted', !watch('termsAccepted'))}>
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map((item, i) => <ScrollReveal key={item.title} delay={i * 0.1}>
      ...
      <section className="py-16 lg:py-24 bg-secondary">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="space-y-3">
            {faqs.map((faq, i) => <div key={i} className="bg-card rounded-xl border border-border overflow-hidden">
